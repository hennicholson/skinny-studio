...
export default function NewModelPage() {
  ...
  const [costPerRunCents, setCostPerRunCents] = useState(5)
  const [costPerSecondCents, setCostPerSecondCents] = useState(1)
  ...
  const handleSave = async () => {
    ...
    if (!replicateModel.trim()) {
      setError('Replicate model is required')
      return
    }
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white">Add New Model</h1>
          <p className="text-sm text-white/50 mt-1">Create a new AI generation model</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-zinc-950 border border-white/[0.06] rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            {pricingType === 'per_run' ? (
              <div>
                <label className="block text-xs text-white/50 mb-1.5">Cost (dollars per run)</label>
              ...
              <div>
                <label className="block text-xs text-white/50 mb-1.5">Cost (dollars per second)</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40">$</span>
                  <input
                    type="number"
        ...
        {/* Advanced */}
        <div className="bg-zinc-950 border border-white/[0.06] rounded-xl p-6">
          <h2 className="text-sm font-medium text-white mb-4">Advanced (Optional)</h2>
          <div className="space-y-4">
            <div>
